...
<!-- AdminLTE App -->
<script src="${SITE_URL}/webjars/adminlte/2.3.11/dist/js/app.min.js"></script>
<!-- Sparkline -->
<script src="${SITE_URL}/webjars/adminlte/2.3.11/plugins/sparkline/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
<script src="${SITE_URL}/webjars/adminlte/2.3.11/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="${SITE_URL}/webjars/adminlte/2.3.11/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- SlimScroll 1.3.0 -->
